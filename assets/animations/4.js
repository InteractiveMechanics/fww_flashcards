...
(lib.btmJaw = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
(lib.rearFin = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
(lib.midFin = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
(lib.BrookTrout = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// midFin
	this.instance = new lib.midFin();
	...
	// frontFin
	this.instance_1 = new lib.frontFin();
	...
	// tailFin
	this.instance_3 = new lib.tailFin();
	...
	// topFin
	this.instance_4 = new lib.topFin();
	...
	// rearFin
	this.instance_5 = new lib.rearFin();
	...
	// btmJaw
	this.instance_6 = new lib.btmJaw();
...
(lib.BrookTrout_mc = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(849.2,544.9,0.327,0.327,0,0,0,107,-194.6);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(50).to({_off:false},0).wait(1).to({regX:119.2,regY:-194.9,x:853.3,y:526.4,startPosition:1},0).wait(1).to({x:853.5,y:508.1,startPosition:2},0).wait(1).to({x:853.6,y:489.7,startPosition:3},0).wait(1).to({x:853.8,y:471.4,startPosition:4},0).wait(1).to({x:853.9,y:453.1,startPosition:5},0).wait(1).to({x:854.1,y:434.7,startPosition:6},0).wait(1).to({x:854.2,y:416.4,startPosition:7},0).wait(1).to({x:854.4,y:398.1,startPosition:8},0).wait(1).to({x:854.5,y:379.7,startPosition:9},0).wait(1).to({x:854.7,y:361.4,startPosition:10},0).wait(1).to({x:854.9,y:343.1,startPosition:11},0).wait(1).to({x:855,y:324.7,startPosition:12},0).wait(1).to({x:855.2,y:306.4,startPosition:13},0).wait(1).to({x:855.3,y:288.1,startPosition:14},0).wait(1).to({x:855.5,y:269.7,startPosition:15},0).wait(1).to({x:855.6,y:251.4,startPosition:16},0).wait(1).to({x:855.8,y:233.1,startPosition:17},0).wait(1).to({x:855.9,y:214.7,startPosition:18},0).wait(1).to({x:856.1,y:196.4,startPosition:19},0).wait(1).to({x:856.3,y:178,startPosition:20},0).wait(1).to({x:856.4,y:159.7,startPosition:21},0).wait(1).to({x:856.6,y:141.4,startPosition:22},0).wait(1).to({x:856.7,y:123,startPosition:23},0).wait(1).to({x:856.9,y:104.7,startPosition:24},0).wait(1).to({x:857,y:86.4,startPosition:25},0).wait(1).to({x:857.2,y:68,startPosition:26},0).wait(1).to({x:857.3,y:49.7,startPosition:27},0).to({_off:true},1).wait(36));

	// bubbles
	this.instance_1 = new lib.bubbles("synched",0);
	this.instance_1.setTransform(277.1,496.9,0.327,0.327,0,0,0,107,-194.6);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(8).to({_off:false},0).wait(1).to({regX:119.2,regY:-194.9,x:281,y:481,startPosition:1},0).wait(1).to({y:465.2,startPosition:2},0).wait(1).to({y:449.4,startPosition:3},0).wait(1).to({y:433.6,startPosition:4},0).wait(1).to({y:417.8,startPosition:5},0).wait(1).to({y:402,startPosition:6},0).wait(1).to({y:386.2,startPosition:7},0).wait(1).to({y:370.4,startPosition:8},0).wait(1).to({y:354.6,startPosition:9},0).wait(1).to({y:338.8,startPosition:10},0).wait(1).to({y:323,startPosition:11},0).wait(1).to({y:307.2,startPosition:12},0).wait(1).to({y:291.4,startPosition:13},0).wait(1).to({x:280.9,y:275.6,startPosition:14},0).wait(1).to({y:259.8,startPosition:15},0).wait(1).to({y:244,startPosition:16},0).wait(1).to({y:228.2,startPosition:17},0).wait(1).to({y:212.4,startPosition:18},0).wait(1).to({y:196.6,startPosition:19},0).wait(1).to({y:180.8,startPosition:20},0).wait(1).to({y:165,startPosition:21},0).wait(1).to({y:149.2,startPosition:22},0).wait(1).to({y:133.4,startPosition:23},0).wait(1).to({y:117.6,startPosition:24},0).wait(1).to({y:101.8,startPosition:25},0).wait(1).to({y:86,startPosition:26},0).wait(1).to({x:280.8,y:70.2,startPosition:27},0).to({_off:true},1).wait(36).to({_off:false,regX:106.9,regY:-192.8,scaleX:0.23,scaleY:0.23,x:114.6,y:559.1,startPosition:0},0).wait(1).to({regX:119.2,regY:-194.9,x:117.3,y:539.6,startPosition:1},0).wait(1).to({y:520.6,startPosition:2},0).wait(1).to({x:117.2,y:501.6,startPosition:3},0).wait(1).to({y:482.6,startPosition:4},0).wait(1).to({x:117.1,y:463.5,startPosition:5},0).wait(1).to({x:117,y:444.5,startPosition:6},0).wait(1).to({y:425.5,startPosition:7},0).wait(1).to({x:116.9,y:406.5,startPosition:8},0).wait(1).to({y:387.5,startPosition:9},0).wait(1).to({x:116.8,y:368.4,startPosition:10},0).wait(1).to({x:116.7,y:349.4,startPosition:11},0).wait(1).to({y:330.4,startPosition:12},0).wait(1).to({x:116.6,y:311.4,startPosition:13},0).wait(1).to({y:292.4,startPosition:14},0).wait(1).to({x:116.5,y:273.3,startPosition:15},0).wait(1).to({y:254.3,startPosition:16},0).wait(1).to({x:116.4,y:235.3,startPosition:17},0).wait(1).to({x:116.3,y:216.3,startPosition:18},0).wait(1).to({y:197.2,startPosition:19},0).wait(1).to({x:116.2,y:178.2,startPosition:20},0).wait(1).to({y:159.2,startPosition:21},0).wait(1).to({x:116.1,y:140.2,startPosition:22},0).wait(1).to({x:116,y:121.1,startPosition:23},0).wait(1).to({y:102.1,startPosition:24},0).wait(1).to({x:115.9,y:83.1,startPosition:25},0).wait(1).to({y:64.1,startPosition:26},0).wait(1).to({x:115.8,y:45.1,startPosition:27},0).to({_off:true},1).wait(14));

	// AmericanShad-all copy
	this.instance_2 = new lib.BrookTrout();
	this.instance_2.setTransform(1142.8,184.9,1.213,1.213,0,0,0,0.1,0.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(1).to({regX:216.2,regY:82.8,x:1359.6,y:288.6},0).wait(1).to({x:1314.3,y:292.1},0).wait(1).to({x:1269.1,y:295.6},0).wait(1).to({x:1223.8,y:299},0).wait(1).to({x:1178.5,y:302.5},0).wait(1).to({x:1133.3,y:306},0).wait(1).to({x:1088,y:309.5},0).wait(1).to({x:1042.7,y:312.9},0).wait(1).to({x:997.4,y:316.4},0).wait(1).to({x:952.1,y:319.9},0).wait(1).to({x:906.8,y:323.4},0).wait(1).to({x:861.6,y:326.8},0).wait(1).to({x:816.3,y:330.3},0).wait(1).to({x:771.1,y:333.8},0).wait(1).to({x:725.7,y:337.3},0).wait(1).to({x:680.5,y:340.7},0).wait(1).to({x:635.2,y:344.2},0).wait(1).to({x:590,y:347.7},0).wait(1).to({x:544.6,y:351.1},0).wait(1).to({x:543.6,y:346.6},0).wait(1).to({x:542.5,y:342.1},0).wait(1).to({x:541.4,y:337.5},0).wait(1).to({x:540.3,y:333},0).wait(1).to({x:539.2,y:328.4},0).wait(1).to({x:538.1,y:323.9},0).wait(1).to({x:537,y:319.3},0).wait(1).to({x:535.9,y:314.8},0).wait(1).to({x:534.8,y:310.2},0).wait(1).to({x:533.7,y:305.7},0).wait(1).to({x:532.6,y:301.1},0).wait(1).to({x:531.7,y:304.2},0).wait(1).to({x:530.8,y:307.3},0).wait(1).to({x:529.8,y:310.3},0).wait(1).to({x:528.9,y:313.4},0).wait(1).to({x:528,y:316.5},0).wait(1).to({x:527,y:319.5},0).wait(1).to({x:526.1,y:322.6},0).wait(1).to({x:525.2,y:325.7},0).wait(1).to({x:524.2,y:328.7},0).wait(1).to({x:523.3,y:331.8},0).wait(1).to({x:522.4,y:334.9},0).wait(1).to({x:521.4,y:337.9},0).wait(1).to({x:520.5,y:341},0).wait(1).to({x:519.6,y:344.1},0).wait(1).to({x:518.6,y:347.1},0).wait(1).to({x:521.7,y:345.1},0).wait(1).to({x:524.8,y:343.1},0).wait(1).to({x:527.9,y:341.2},0).wait(1).to({x:531,y:339.1},0).wait(1).to({x:534.1,y:337.1},0).wait(1).to({x:537.2,y:335.2},0).wait(1).to({x:540.3,y:333.2},0).wait(1).to({x:543.4,y:331.1},0).wait(1).to({x:546.5,y:329.1},0).wait(1).to({x:549.6,y:327.1},0).wait(1).to({x:552.6,y:325.1},0).wait(1).to({x:519.5,y:325.2},0).wait(1).to({x:486.4},0).wait(1).to({x:453.2,y:325.3},0).wait(1).to({x:420.1},0).wait(1).to({x:387,y:325.4},0).wait(1).to({x:353.8},0).wait(1).to({x:320.7},0).wait(1).to({x:287.6,y:325.5},0).wait(1).to({x:254.5},0).wait(1).to({x:221.4,y:325.6},0).wait(1).to({x:188.2},0).wait(1).to({x:155.1,y:325.7},0).wait(1).to({x:122},0).wait(1).to({x:88.9},0).wait(1).to({x:55.7,y:325.8},0).wait(1).to({x:22.5},0).wait(1).to({x:-10.6,y:325.9},0).wait(1).to({x:-43.7},0).wait(1).to({x:-76.9,y:326},0).wait(1).to({x:-110},0).wait(1).to({x:-143.1},0).wait(1).to({x:-176.3,y:326.1},0).wait(1).to({x:-209.4},0).wait(1).to({x:-242.5,y:326.2},0).wait(1).to({x:-275.6},0).wait(1).to({x:-308.8},0).wait(1).to({x:-341.9,y:326.3},0).wait(1).to({x:-375},0).wait(1).to({x:-408.2,y:326.4},0).wait(1).to({x:-441.3},0).wait(1).to({x:-474.4,y:326.5},0).wait(1).to({x:-507.6},0).to({_off:true},1).wait(25));

	// AmericanShad-all copy 2
	this.instance_3 = new lib.BrookTrout();
	this.instance_3.setTransform(1173.7,326.9,0.857,0.857);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(31).to({_off:false},0).wait(1).to({regX:216.2,regY:82.8,x:1305.1,y:402},0).wait(1).to({x:1251.1,y:406.1},0).wait(1).to({x:1197.1,y:410.3},0).wait(1).to({x:1143.1,y:414.4},0).wait(1).to({x:1089.1,y:418.6},0).wait(1).to({x:1035.1,y:422.7},0).wait(1).to({x:981.1,y:426.8},0).wait(1).to({x:927.1,y:431},0).wait(1).to({x:873.1,y:435.1},0).wait(1).to({x:819.1,y:439.3},0).wait(1).to({x:765.1,y:443.4},0).wait(1).to({x:711.1,y:447.6},0).wait(1).to({x:657.1,y:451.7},0).wait(1).to({x:603.1,y:455.8},0).wait(1).to({x:601.8,y:450.4},0).wait(1).to({x:600.5,y:444.9},0).wait(1).to({x:599.1,y:439.4},0).wait(1).to({x:597.8,y:433.9},0).wait(1).to({x:596.5,y:428.4},0).wait(1).to({x:595.2,y:422.9},0).wait(1).to({x:593.9,y:417.4},0).wait(1).to({x:592.6,y:411.9},0).wait(1).to({x:591.4,y:415.6},0).wait(1).to({x:590.3,y:419.3},0).wait(1).to({x:589.2,y:422.9},0).wait(1).to({x:588.1,y:426.6},0).wait(1).to({x:587,y:430.3},0).wait(1).to({x:585.8,y:434},0).wait(1).to({x:584.7,y:437.6},0).wait(1).to({x:583.6,y:441.3},0).wait(1).to({x:582.5,y:445},0).wait(1).to({x:581.4,y:448.7},0).wait(1).to({x:580.3,y:452.3},0).wait(1).to({x:584,y:449.9},0).wait(1).to({x:587.7,y:447.5},0).wait(1).to({x:591.5,y:445.1},0).wait(1).to({x:595.2,y:442.7},0).wait(1).to({x:598.9,y:440.3},0).wait(1).to({x:602.7,y:437.8},0).wait(1).to({x:606.4,y:435.4},0).wait(1).to({x:610.2,y:433},0).wait(1).to({x:559.2,y:433.9},0).wait(1).to({x:508.3,y:434.9},0).wait(1).to({x:457.3,y:435.8},0).wait(1).to({x:406.4,y:436.7},0).wait(1).to({x:355.5,y:437.7},0).wait(1).to({x:304.5,y:438.6},0).wait(1).to({x:253.6,y:439.5},0).wait(1).to({x:202.7,y:440.5},0).wait(1).to({x:151.8,y:441.4},0).wait(1).to({x:100.8,y:442.3},0).wait(1).to({x:49.9,y:443.3},0).wait(1).to({x:-1,y:444.2},0).wait(1).to({x:-52,y:445.2},0).wait(1).to({x:-102.9,y:446.1},0).wait(1).to({x:-153.9,y:447},0).wait(1).to({x:-204.8,y:448},0).wait(1).to({x:-255.7,y:448.9},0).wait(1).to({x:-306.7,y:449.8},0).wait(1).to({x:-357.6,y:450.8},0).wait(1).to({x:-408.5,y:451.7},0).wait(1).to({x:-459.5,y:452.6},0).wait(1).to({x:-510.4,y:453.6},0).wait(1).to({x:-561.4,y:454.5},0).wait(8).to({_off:true},1).wait(10));

	// AmericanShad-all
	this.instance_4 = new lib.BrookTrout();
	this.instance_4.setTransform(1394.9,30.9,1.213,1.213,0,0,0,0.1,0.1);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(14).to({_off:false},0).wait(1).to({regX:216.2,regY:82.8,x:1611.6,y:134.6},0).wait(1).to({x:1566.4,y:138.1},0).wait(1).to({x:1521.1,y:141.6},0).wait(1).to({x:1475.8,y:145},0).wait(1).to({x:1430.5,y:148.5},0).wait(1).to({x:1385.3,y:152},0).wait(1).to({x:1340,y:155.5},0).wait(1).to({x:1294.7,y:158.9},0).wait(1).to({x:1249.5,y:162.4},0).wait(1).to({x:1204.2,y:165.9},0).wait(1).to({x:1158.9,y:169.4},0).wait(1).to({x:1113.7,y:172.8},0).wait(1).to({x:1068.3,y:176.3},0).wait(1).to({x:1023.1,y:179.8},0).wait(1).to({x:977.8,y:183.3},0).wait(1).to({x:932.5,y:186.7},0).wait(1).to({x:887.2,y:190.2},0).wait(1).to({x:842,y:193.7},0).wait(1).to({x:796.7,y:197.1},0).wait(1).to({x:795.6,y:192.6},0).wait(1).to({x:794.5,y:188.1},0).wait(1).to({x:793.4,y:183.5},0).wait(1).to({x:792.3,y:179},0).wait(1).to({x:791.2,y:174.4},0).wait(1).to({x:790.2,y:169.9},0).wait(1).to({x:789.1,y:165.3},0).wait(1).to({x:788,y:160.8},0).wait(1).to({x:786.9,y:156.2},0).wait(1).to({x:785.8,y:151.7},0).wait(1).to({x:784.7,y:147.1},0).wait(1).to({x:783.8,y:150.2},0).wait(1).to({x:782.8,y:153.3},0).wait(1).to({x:781.9,y:156.3},0).wait(1).to({x:781,y:159.4},0).wait(1).to({x:780,y:162.5},0).wait(1).to({x:779.1,y:165.5},0).wait(1).to({x:778.2,y:168.6},0).wait(1).to({x:777.2,y:171.7},0).wait(1).to({x:776.3,y:174.7},0).wait(1).to({x:775.4,y:177.8},0).wait(1).to({x:774.4,y:180.9},0).wait(1).to({x:773.5,y:183.9},0).wait(1).to({x:772.6,y:187},0).wait(1).to({x:771.6,y:190.1},0).wait(1).to({x:770.7,y:193.1},0).wait(1).to({x:773.8,y:191.1},0).wait(1).to({x:776.9,y:189.1},0).wait(1).to({x:780,y:187.2},0).wait(1).to({x:783.1,y:185.1},0).wait(1).to({x:786.2,y:183.1},0).wait(1).to({x:789.2,y:181.2},0).wait(1).to({x:792.3,y:179.2},0).wait(1).to({x:795.4,y:177.1},0).wait(1).to({x:798.5,y:175.1},0).wait(1).to({x:801.6,y:173.1},0).wait(1).to({x:804.7,y:171.1},0).wait(1).to({x:764.3,y:170.8},0).wait(1).to({x:723.9,y:170.5},0).wait(1).to({x:683.5,y:170.2},0).wait(1).to({x:643.1,y:169.9},0).wait(1).to({x:602.7,y:169.6},0).wait(1).to({x:562.3,y:169.3},0).wait(1).to({x:521.9,y:169},0).wait(1).to({x:481.4,y:168.6},0).wait(1).to({x:441,y:168.3},0).wait(1).to({x:400.6,y:168},0).wait(1).to({x:360.2,y:167.7},0).wait(1).to({x:319.8,y:167.4},0).wait(1).to({x:279.4,y:167.1},0).wait(1).to({x:239.1,y:166.8},0).wait(1).to({x:198.6,y:166.5},0).wait(1).to({x:158.2,y:166.1},0).wait(1).to({x:117.8,y:165.8},0).wait(1).to({x:77.4,y:165.5},0).wait(1).to({x:37,y:165.2},0).wait(1).to({x:-3.4,y:164.9},0).wait(1).to({x:-43.8,y:164.6},0).wait(1).to({x:-84.2,y:164.3},0).wait(1).to({x:-124.6,y:164},0).wait(1).to({x:-165,y:163.6},0).wait(1).to({x:-205.4,y:163.3},0).wait(1).to({x:-245.9,y:163},0).wait(1).to({x:-286.3,y:162.7},0).wait(1).to({x:-326.6,y:162.4},0).wait(1).to({x:-367.1,y:162.1},0).wait(1).to({x:-407.5,y:161.8},0).wait(1).to({x:-447.9,y:161.5},0).wait(1).to({x:-488.3,y:161.1},0).wait(1).to({_off:true},1).wait(10));

	// bkgr
	this.instance_5 = new lib.bkgr();
	this.instance_5.setTransform(537.1,425.1,1,1,0,0,0,587.1,475.1);
	this.instance_5.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(1).to({regX:587.2,regY:475.2,x:537.2,y:425.2,alpha:0.117},0).wait(1).to({alpha:0.233},0).wait(1).to({alpha:0.35},0).wait(1).to({alpha:0.467},0).wait(1).to({alpha:0.583},0).wait(1).to({alpha:0.7},0).wait(99).to({alpha:0.622},0).wait(1).to({alpha:0.544},0).wait(1).to({alpha:0.467},0).wait(1).to({alpha:0.389},0).wait(1).to({alpha:0.311},0).wait(1).to({alpha:0.233},0).wait(1).to({alpha:0.156},0).wait(1).to({alpha:0.078},0).wait(1).to({alpha:0},0).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-277.2,-106.7,1942.7,1063.9);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	// Brook Trout
	this.instance = new lib.BrookTrout_mc("synched",0);
	this.instance.setTransform(1223.7,549.1,1.51,1.51,0,0,0,662.9,350.9);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({_off:true},156).wait(84));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(763.9,398,2933.8,1606.6);
