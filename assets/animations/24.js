...
p.nominalBounds = new cjs.Rectangle(-153.1,-84.8,302.3,169.7);
...
p.nominalBounds = new cjs.Rectangle(284,-130.4,199.6,125.2);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.instance.setTransform(820.6,617.1,1.589,1.589,0,0,0,464.2,445.2);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({_off:true},110).wait(130));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(1494.3,242.6,317.1,199);
