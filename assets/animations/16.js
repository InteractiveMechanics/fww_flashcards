...
(lib.Tween6 = function(mode,startPosition,loop) {
	...
	this.shape.graphics.f("#274B20").s().p("");
	this.shape.setTransform(-43.7,-25.6);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#2F5326").s().p("");
	this.shape_1.setTransform(-37.4,-21.5);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#365B2C").s().p("");
	this.shape_2.setTransform(-31.2,-17.4);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#3D6431").s().p("");
	this.shape_3.setTransform(-25.2,-13.3);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#446C36").s().p("");
	this.shape_4.setTransform(-19.5,-9.7);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#4B753B").s().p("");
	this.shape_5.setTransform(-13.5,-6.4);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#517D40").s().p("");
	this.shape_6.setTransform(-6.6,-3.1);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#588545").s().p("");
...
(lib.ripple = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("rgba(255,255,255,0.8)").ss(1,1,1).p("AAWgBQAJABAAAAQAAABgJABQgJABgNAAQgMAAgJgBQgJgBAAgBQAAAAAJgBQAJgBAMAAQANAAAJABg");
	this.shape.setTransform(34.1,273.1);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("rgba(255,255,255,0.769)").ss(1.1,1,1).p("AhrAAQAAgDAggDQAfgCAsAAQAtAAAfACQAgADAAADQAAADggADQgfADgtAAQgsAAgfgDQgggDAAgDg");
	this.shape_1.setTransform(34.4,273.1);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f().s("rgba(255,255,255,0.737)").ss(1.2,1,1).p("Ai3AAQAAgGA1gEQA2gFBMAAQBMAAA2AFQA2AEAAAGQAAAGg2AFQg2AEhMAAQhMAAg2gEQg1gFAAgGg");
	this.shape_2.setTransform(34.7,273.1);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f().s("rgba(255,255,255,0.706)").ss(1.3,1,1).p("AkEAAQAAgIBMgHQBNgGBrAAQBsAABNAGQBMAHAAAIQAAAJhMAHQhNAGhsAAQhrAAhNgGQhMgHAAgJg");
	this.shape_3.setTransform(35,273.1);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f().s("rgba(255,255,255,0.671)").ss(1.3,1,1).p("AlRAAQAAgLBjgJQBjgICLAAQCMAABjAIQBjAJAAALQAAAMhjAIQhjAIiMAAQiLAAhjgIQhjgIAAgMg");
	this.shape_4.setTransform(35.2,273.1);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f().s("rgba(255,255,255,0.639)").ss(1.4,1,1).p("AmeAAQAAgOB6gKQB5gKCrAAQCsAAB5AKQB6AKAAAOQAAAOh6ALQh5AKisAAQirAAh5gKQh6gLAAgOg");
	this.shape_5.setTransform(35.5,273.1);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f().s("rgba(255,255,255,0.608)").ss(1.5,1,1).p("AnqAAQAAgQCPgNQCQgMDLAAQDLAACQAMQCQANAAAQQAAARiQAMQiQAMjLAAQjLAAiQgMQiPgMAAgRg");
	this.shape_6.setTransform(35.8,273.1);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f().s("rgba(255,255,255,0.576)").ss(1.6,1,1).p("Ao3AAQAAgTCmgOQCngODqAAQDrAACmAOQCnAOAAATQAAAUinAOQimAOjrAAQjqAAingOQimgOAAgUg");
	this.shape_7.setTransform(36.1,273.1);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f().s("rgba(255,255,255,0.545)").ss(1.7,1,1).p("AqEAAQAAgWC9gQQC9gQEKAAQELAAC9AQQC8AQAAAWQAAAWi8ARQi9AQkLAAQkKAAi9gQQi9gRAAgWg");
	this.shape_8.setTransform(36.4,273.1);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f().s("rgba(255,255,255,0.514)").ss(1.7,1,1).p("ArQAAQAAgYDTgTQDTgREqAAQErAADTARQDTATAAAYQAAAZjTASQjTASkrAAQkqAAjTgSQjTgSAAgZg");
	this.shape_9.setTransform(36.7,273.1);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f().s("rgba(255,255,255,0.478)").ss(1.8,1,1).p("AsdAAQAAgbDqgUQDpgUFKAAQFKAADqAUQDqAUAAAbQAAAcjqAUQjqAUlKAAQlKAAjpgUQjqgUAAgcg");
	this.shape_10.setTransform(36.9,273.1);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f().s("rgba(255,255,255,0.447)").ss(1.9,1,1).p("AtqAAQAAgeEAgWQEAgVFqAAQFqAAEAAVQEBAWAAAeQAAAekBAWQkAAWlqAAQlqAAkAgWQkAgWAAgeg");
	this.shape_11.setTransform(37.2,273.1);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f().s("rgba(255,255,255,0.416)").ss(2,1,1).p("Au2AAQAAggEWgYQEXgYGJAAQGKAAEWAYQEXAYAAAgQAAAhkXAYQkWAYmKAAQmJAAkXgYQkWgYAAghg");
	this.shape_12.setTransform(37.5,273.1);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f().s("rgba(255,255,255,0.384)").ss(2.1,1,1).p("AwDAAQAAgjEtgaQEtgaGpAAQGqAAEtAaQEtAaAAAjQAAAkktAaQktAamqAAQmpAAktgaQktgaAAgkg");
	this.shape_13.setTransform(37.8,273.1);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f().s("rgba(255,255,255,0.353)").ss(2.1,1,1).p("AxPAAQAAgmFDgcQFDgbHJAAQHJAAFEAbQFDAcAAAmQAAAnlDAbQlEAcnJAAQnJAAlDgcQlDgbAAgng");
	this.shape_14.setTransform(38,273.1);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f().s("rgba(255,255,255,0.322)").ss(2.2,1,1).p("AycAAQAAgoFZgeQFageHpAAQHpAAFaAeQFaAeAAAoQAAAplaAeQlaAdnpAAQnpAAlagdQlZgeAAgpg");
	this.shape_15.setTransform(38.3,273.1);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f().s("rgba(255,255,255,0.286)").ss(2.3,1,1).p("AzpAAQAAgrFxggQFwgfIIAAQIJAAFwAfQFxAgAAArQAAAslxAfQlwAgoJAAQoIAAlwggQlxgfAAgsg");
	this.shape_16.setTransform(38.6,273.1);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f().s("rgba(255,255,255,0.255)").ss(2.4,1,1).p("A01AAQAAguGGghQGHgiIoAAQIoAAGHAiQGHAhAAAuQAAAvmHAhQmHAhooAAQooAAmHghQmGghAAgvg");
	this.shape_17.setTransform(38.9,273.1);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f().s("rgba(255,255,255,0.224)").ss(2.5,1,1).p("A2CAAQAAgwGdgkQGdgjJIAAQJIAAGeAjQGdAkAAAwQAAAxmdAkQmeAjpIAAQpIAAmdgjQmdgkAAgxg");
	this.shape_18.setTransform(39.2,273.1);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f().s("rgba(255,255,255,0.192)").ss(2.5,1,1).p("A3PAAQAAgzG0gmQG0glJnAAQJoAAG0AlQG0AmAAAzQAAA0m0AlQm0AmpoAAQpnAAm0gmQm0glAAg0g");
	this.shape_19.setTransform(39.4,273.1);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f().s("rgba(255,255,255,0.161)").ss(2.6,1,1).p("A4bAAQAAg2HJgnQHLgnKHAAQKIAAHKAnQHKAnAAA2QAAA3nKAnQnKAnqIAAQqHAAnLgnQnJgnAAg3g");
	this.shape_20.setTransform(39.7,273.1);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f().s("rgba(255,255,255,0.129)").ss(2.7,1,1).p("A5oAAQAAg5HggpQHhgpKnAAQKoAAHgApQHhApAAA5QAAA5nhApQngAqqoAAQqnAAnhgqQnggpAAg5g");
	this.shape_21.setTransform(40,273.1);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f().s("rgba(255,255,255,0.094)").ss(2.8,1,1).p("A61AAQAAg7H3grQH3grLHAAQLHAAH3ArQH4ArAAA7QAAA8n4ArQn3ArrHAAQrHAAn3grQn3grAAg8g");
	this.shape_22.setTransform(40.3,273.1);

	this.shape_23 = new cjs.Shape();
	this.shape_23.graphics.f().s("rgba(255,255,255,0.063)").ss(2.9,1,1).p("A8CAAQAAg+IOgtQINgtLnAAQLnAAIOAtQIOAtAAA+QAAA/oOAtQoOAtrnAAQrnAAoNgtQoOgtAAg/g");
	this.shape_23.setTransform(40.6,273.1);

	this.shape_24 = new cjs.Shape();
	this.shape_24.graphics.f().s("rgba(255,255,255,0.031)").ss(2.9,1,1).p("A9OAAQAAhBIjgvQIkguMHAAQMHAAIkAuQIkAvAABBQAABCokAuQokAvsHAAQsHAAokgvQojguAAhCg");
	this.shape_24.setTransform(40.9,273.1);

	this.shape_25 = new cjs.Shape();
	this.shape_25.graphics.f().s("rgba(255,255,255,0)").ss(3,1,1).p("AVhB1Qo7AxsmAAQsmAAo7gxQo6gxAAhEQAAhDI6gxQI7gxMmAAQMmAAI7AxQI7AxAABDQAABEo7Axg");
	...
	this.shape_26.graphics.f().s("rgba(255,255,255,0.8)").ss(1,1,1).p("AAWgBQAJABAAAAQAAABgJABQgJABgNAAQgMAAgJgBQgJgBAAgBQAAAAAJgBQAJgBAMAAQANAAAJABg");
	this.shape_26.setTransform(34.1,273.1);

	this.shape_27 = new cjs.Shape();
	this.shape_27.graphics.f().s("rgba(255,255,255,0.769)").ss(1.1,1,1).p("AhrAAQAAgDAggDQAfgCAsAAQAtAAAfACQAgADAAADQAAADggADQgfADgtAAQgsAAgfgDQgggDAAgDg");
	this.shape_27.setTransform(34.4,273.1);

	this.shape_28 = new cjs.Shape();
	this.shape_28.graphics.f().s("rgba(255,255,255,0.737)").ss(1.2,1,1).p("Ai3AAQAAgGA1gEQA2gFBMAAQBMAAA2AFQA2AEAAAGQAAAGg2AFQg2AEhMAAQhMAAg2gEQg1gFAAgGg");
	this.shape_28.setTransform(34.7,273.1);

	this.shape_29 = new cjs.Shape();
	this.shape_29.graphics.f().s("rgba(255,255,255,0.706)").ss(1.3,1,1).p("AkEAAQAAgIBMgHQBNgGBrAAQBsAABNAGQBMAHAAAIQAAAJhMAHQhNAGhsAAQhrAAhNgGQhMgHAAgJg");
	this.shape_29.setTransform(35,273.1);

	this.shape_30 = new cjs.Shape();
	this.shape_30.graphics.f().s("rgba(255,255,255,0.671)").ss(1.3,1,1).p("AlRAAQAAgLBjgJQBjgICLAAQCMAABjAIQBjAJAAALQAAAMhjAIQhjAIiMAAQiLAAhjgIQhjgIAAgMg");
	this.shape_30.setTransform(35.2,273.1);

	this.shape_31 = new cjs.Shape();
	this.shape_31.graphics.f().s("rgba(255,255,255,0.639)").ss(1.4,1,1).p("AmeAAQAAgOB6gKQB5gKCrAAQCsAAB5AKQB6AKAAAOQAAAOh6ALQh5AKisAAQirAAh5gKQh6gLAAgOg");
	this.shape_31.setTransform(35.5,273.1);

	this.shape_32 = new cjs.Shape();
	this.shape_32.graphics.f().s("rgba(255,255,255,0.608)").ss(1.5,1,1).p("AnqAAQAAgQCPgNQCQgMDLAAQDLAACQAMQCQANAAAQQAAARiQAMQiQAMjLAAQjLAAiQgMQiPgMAAgRg");
	this.shape_32.setTransform(35.8,273.1);

	this.shape_33 = new cjs.Shape();
	this.shape_33.graphics.f().s("rgba(255,255,255,0.576)").ss(1.6,1,1).p("Ao3AAQAAgTCmgOQCngODqAAQDrAACmAOQCnAOAAATQAAAUinAOQimAOjrAAQjqAAingOQimgOAAgUg");
	this.shape_33.setTransform(36.1,273.1);

	this.shape_34 = new cjs.Shape();
	this.shape_34.graphics.f().s("rgba(255,255,255,0.545)").ss(1.7,1,1).p("AqEAAQAAgWC9gQQC9gQEKAAQELAAC9AQQC8AQAAAWQAAAWi8ARQi9AQkLAAQkKAAi9gQQi9gRAAgWg");
	this.shape_34.setTransform(36.4,273.1);

	this.shape_35 = new cjs.Shape();
	this.shape_35.graphics.f().s("rgba(255,255,255,0.514)").ss(1.7,1,1).p("ArQAAQAAgYDTgTQDTgREqAAQErAADTARQDTATAAAYQAAAZjTASQjTASkrAAQkqAAjTgSQjTgSAAgZg");
	this.shape_35.setTransform(36.7,273.1);

	this.shape_36 = new cjs.Shape();
	this.shape_36.graphics.f().s("rgba(255,255,255,0.478)").ss(1.8,1,1).p("AsdAAQAAgbDqgUQDpgUFKAAQFKAADqAUQDqAUAAAbQAAAcjqAUQjqAUlKAAQlKAAjpgUQjqgUAAgcg");
	this.shape_36.setTransform(36.9,273.1);

	this.shape_37 = new cjs.Shape();
	this.shape_37.graphics.f().s("rgba(255,255,255,0.447)").ss(1.9,1,1).p("AtqAAQAAgeEAgWQEAgVFqAAQFqAAEAAVQEBAWAAAeQAAAekBAWQkAAWlqAAQlqAAkAgWQkAgWAAgeg");
	this.shape_37.setTransform(37.2,273.1);

	this.shape_38 = new cjs.Shape();
	this.shape_38.graphics.f().s("rgba(255,255,255,0.416)").ss(2,1,1).p("Au2AAQAAggEWgYQEXgYGJAAQGKAAEWAYQEXAYAAAgQAAAhkXAYQkWAYmKAAQmJAAkXgYQkWgYAAghg");
	this.shape_38.setTransform(37.5,273.1);

	this.shape_39 = new cjs.Shape();
	this.shape_39.graphics.f().s("rgba(255,255,255,0.384)").ss(2.1,1,1).p("AwDAAQAAgjEtgaQEtgaGpAAQGqAAEtAaQEtAaAAAjQAAAkktAaQktAamqAAQmpAAktgaQktgaAAgkg");
	this.shape_39.setTransform(37.8,273.1);

	this.shape_40 = new cjs.Shape();
	this.shape_40.graphics.f().s("rgba(255,255,255,0.353)").ss(2.1,1,1).p("AxPAAQAAgmFDgcQFDgbHJAAQHJAAFEAbQFDAcAAAmQAAAnlDAbQlEAcnJAAQnJAAlDgcQlDgbAAgng");
	this.shape_40.setTransform(38,273.1);

	this.shape_41 = new cjs.Shape();
	this.shape_41.graphics.f().s("rgba(255,255,255,0.322)").ss(2.2,1,1).p("AycAAQAAgoFZgeQFageHpAAQHpAAFaAeQFaAeAAAoQAAAplaAeQlaAdnpAAQnpAAlagdQlZgeAAgpg");
	this.shape_41.setTransform(38.3,273.1);

	this.shape_42 = new cjs.Shape();
	this.shape_42.graphics.f().s("rgba(255,255,255,0.286)").ss(2.3,1,1).p("AzpAAQAAgrFxggQFwgfIIAAQIJAAFwAfQFxAgAAArQAAAslxAfQlwAgoJAAQoIAAlwggQlxgfAAgsg");
	this.shape_42.setTransform(38.6,273.1);

	this.shape_43 = new cjs.Shape();
	this.shape_43.graphics.f().s("rgba(255,255,255,0.255)").ss(2.4,1,1).p("A01AAQAAguGGghQGHgiIoAAQIoAAGHAiQGHAhAAAuQAAAvmHAhQmHAhooAAQooAAmHghQmGghAAgvg");
	this.shape_43.setTransform(38.9,273.1);

	this.shape_44 = new cjs.Shape();
	this.shape_44.graphics.f().s("rgba(255,255,255,0.224)").ss(2.5,1,1).p("A2CAAQAAgwGdgkQGdgjJIAAQJIAAGeAjQGdAkAAAwQAAAxmdAkQmeAjpIAAQpIAAmdgjQmdgkAAgxg");
	this.shape_44.setTransform(39.2,273.1);

	this.shape_45 = new cjs.Shape();
	this.shape_45.graphics.f().s("rgba(255,255,255,0.192)").ss(2.5,1,1).p("A3PAAQAAgzG0gmQG0glJnAAQJoAAG0AlQG0AmAAAzQAAA0m0AlQm0AmpoAAQpnAAm0gmQm0glAAg0g");
	this.shape_45.setTransform(39.4,273.1);

	this.shape_46 = new cjs.Shape();
	this.shape_46.graphics.f().s("rgba(255,255,255,0.161)").ss(2.6,1,1).p("A4bAAQAAg2HJgnQHLgnKHAAQKIAAHKAnQHKAnAAA2QAAA3nKAnQnKAnqIAAQqHAAnLgnQnJgnAAg3g");
	this.shape_46.setTransform(39.7,273.1);

	this.shape_47 = new cjs.Shape();
	this.shape_47.graphics.f().s("rgba(255,255,255,0.129)").ss(2.7,1,1).p("A5oAAQAAg5HggpQHhgpKnAAQKoAAHgApQHhApAAA5QAAA5nhApQngAqqoAAQqnAAnhgqQnggpAAg5g");
	this.shape_47.setTransform(40,273.1);

	this.shape_48 = new cjs.Shape();
	this.shape_48.graphics.f().s("rgba(255,255,255,0.094)").ss(2.8,1,1).p("A61AAQAAg7H3grQH3grLHAAQLHAAH3ArQH4ArAAA7QAAA8n4ArQn3ArrHAAQrHAAn3grQn3grAAg8g");
	this.shape_48.setTransform(40.3,273.1);

	this.shape_49 = new cjs.Shape();
	this.shape_49.graphics.f().s("rgba(255,255,255,0.063)").ss(2.9,1,1).p("A8CAAQAAg+IOgtQINgtLnAAQLnAAIOAtQIOAtAAA+QAAA/oOAtQoOAtrnAAQrnAAoNgtQoOgtAAg/g");
	this.shape_49.setTransform(40.6,273.1);

	this.shape_50 = new cjs.Shape();
	this.shape_50.graphics.f().s("rgba(255,255,255,0.031)").ss(2.9,1,1).p("A9OAAQAAhBIjgvQIkguMHAAQMHAAIkAuQIkAvAABBQAABCokAuQokAvsHAAQsHAAokgvQojguAAhCg");
	this.shape_50.setTransform(40.9,273.1);

	this.shape_51 = new cjs.Shape();
	this.shape_51.graphics.f().s("rgba(255,255,255,0)").ss(3,1,1).p("AVhB1Qo7AxsmAAQsmAAo7gxQo6gxAAhEQAAhDI6gxQI7gxMmAAQMmAAI7AxQI7AxAABDQAABEo7Axg");
	...
	this.shape_52.graphics.f().s("rgba(255,255,255,0.8)").ss(1,1,1).p("AAWgBQAJABAAAAQAAABgJABQgJABgNAAQgMAAgJgBQgJgBAAgBQAAAAAJgBQAJgBAMAAQANAAAJABg");
	this.shape_52.setTransform(34.1,273.1);

	this.shape_53 = new cjs.Shape();
	this.shape_53.graphics.f().s("rgba(255,255,255,0.769)").ss(1.1,1,1).p("AhrAAQAAgDAggDQAfgCAsAAQAtAAAfACQAgADAAADQAAADggADQgfADgtAAQgsAAgfgDQgggDAAgDg");
	this.shape_53.setTransform(34.4,273.1);

	this.shape_54 = new cjs.Shape();
	this.shape_54.graphics.f().s("rgba(255,255,255,0.737)").ss(1.2,1,1).p("Ai3AAQAAgGA1gEQA2gFBMAAQBMAAA2AFQA2AEAAAGQAAAGg2AFQg2AEhMAAQhMAAg2gEQg1gFAAgGg");
	this.shape_54.setTransform(34.7,273.1);

	this.shape_55 = new cjs.Shape();
	this.shape_55.graphics.f().s("rgba(255,255,255,0.706)").ss(1.3,1,1).p("AkEAAQAAgIBMgHQBNgGBrAAQBsAABNAGQBMAHAAAIQAAAJhMAHQhNAGhsAAQhrAAhNgGQhMgHAAgJg");
	this.shape_55.setTransform(35,273.1);

	this.shape_56 = new cjs.Shape();
	this.shape_56.graphics.f().s("rgba(255,255,255,0.671)").ss(1.3,1,1).p("AlRAAQAAgLBjgJQBjgICLAAQCMAABjAIQBjAJAAALQAAAMhjAIQhjAIiMAAQiLAAhjgIQhjgIAAgMg");
	this.shape_56.setTransform(35.2,273.1);

	this.shape_57 = new cjs.Shape();
	this.shape_57.graphics.f().s("rgba(255,255,255,0.639)").ss(1.4,1,1).p("AmeAAQAAgOB6gKQB5gKCrAAQCsAAB5AKQB6AKAAAOQAAAOh6ALQh5AKisAAQirAAh5gKQh6gLAAgOg");
	this.shape_57.setTransform(35.5,273.1);

	this.shape_58 = new cjs.Shape();
	this.shape_58.graphics.f().s("rgba(255,255,255,0.608)").ss(1.5,1,1).p("AnqAAQAAgQCPgNQCQgMDLAAQDLAACQAMQCQANAAAQQAAARiQAMQiQAMjLAAQjLAAiQgMQiPgMAAgRg");
	this.shape_58.setTransform(35.8,273.1);

	this.shape_59 = new cjs.Shape();
	this.shape_59.graphics.f().s("rgba(255,255,255,0.576)").ss(1.6,1,1).p("Ao3AAQAAgTCmgOQCngODqAAQDrAACmAOQCnAOAAATQAAAUinAOQimAOjrAAQjqAAingOQimgOAAgUg");
	this.shape_59.setTransform(36.1,273.1);

	this.shape_60 = new cjs.Shape();
	this.shape_60.graphics.f().s("rgba(255,255,255,0.545)").ss(1.7,1,1).p("AqEAAQAAgWC9gQQC9gQEKAAQELAAC9AQQC8AQAAAWQAAAWi8ARQi9AQkLAAQkKAAi9gQQi9gRAAgWg");
	this.shape_60.setTransform(36.4,273.1);

	this.shape_61 = new cjs.Shape();
	this.shape_61.graphics.f().s("rgba(255,255,255,0.514)").ss(1.7,1,1).p("ArQAAQAAgYDTgTQDTgREqAAQErAADTARQDTATAAAYQAAAZjTASQjTASkrAAQkqAAjTgSQjTgSAAgZg");
	this.shape_61.setTransform(36.7,273.1);

	this.shape_62 = new cjs.Shape();
	this.shape_62.graphics.f().s("rgba(255,255,255,0.478)").ss(1.8,1,1).p("AsdAAQAAgbDqgUQDpgUFKAAQFKAADqAUQDqAUAAAbQAAAcjqAUQjqAUlKAAQlKAAjpgUQjqgUAAgcg");
	this.shape_62.setTransform(36.9,273.1);

	this.shape_63 = new cjs.Shape();
	this.shape_63.graphics.f().s("rgba(255,255,255,0.447)").ss(1.9,1,1).p("AtqAAQAAgeEAgWQEAgVFqAAQFqAAEAAVQEBAWAAAeQAAAekBAWQkAAWlqAAQlqAAkAgWQkAgWAAgeg");
	this.shape_63.setTransform(37.2,273.1);

	this.shape_64 = new cjs.Shape();
	this.shape_64.graphics.f().s("rgba(255,255,255,0.416)").ss(2,1,1).p("Au2AAQAAggEWgYQEXgYGJAAQGKAAEWAYQEXAYAAAgQAAAhkXAYQkWAYmKAAQmJAAkXgYQkWgYAAghg");
	this.shape_64.setTransform(37.5,273.1);

	this.shape_65 = new cjs.Shape();
	this.shape_65.graphics.f().s("rgba(255,255,255,0.384)").ss(2.1,1,1).p("AwDAAQAAgjEtgaQEtgaGpAAQGqAAEtAaQEtAaAAAjQAAAkktAaQktAamqAAQmpAAktgaQktgaAAgkg");
	this.shape_65.setTransform(37.8,273.1);

	this.shape_66 = new cjs.Shape();
	this.shape_66.graphics.f().s("rgba(255,255,255,0.353)").ss(2.1,1,1).p("AxPAAQAAgmFDgcQFDgbHJAAQHJAAFEAbQFDAcAAAmQAAAnlDAbQlEAcnJAAQnJAAlDgcQlDgbAAgng");
	this.shape_66.setTransform(38,273.1);

	this.shape_67 = new cjs.Shape();
	this.shape_67.graphics.f().s("rgba(255,255,255,0.322)").ss(2.2,1,1).p("AycAAQAAgoFZgeQFageHpAAQHpAAFaAeQFaAeAAAoQAAAplaAeQlaAdnpAAQnpAAlagdQlZgeAAgpg");
	this.shape_67.setTransform(38.3,273.1);

	this.shape_68 = new cjs.Shape();
	this.shape_68.graphics.f().s("rgba(255,255,255,0.286)").ss(2.3,1,1).p("AzpAAQAAgrFxggQFwgfIIAAQIJAAFwAfQFxAgAAArQAAAslxAfQlwAgoJAAQoIAAlwggQlxgfAAgsg");
	this.shape_68.setTransform(38.6,273.1);

	this.shape_69 = new cjs.Shape();
	this.shape_69.graphics.f().s("rgba(255,255,255,0.255)").ss(2.4,1,1).p("A01AAQAAguGGghQGHgiIoAAQIoAAGHAiQGHAhAAAuQAAAvmHAhQmHAhooAAQooAAmHghQmGghAAgvg");
	this.shape_69.setTransform(38.9,273.1);

	this.shape_70 = new cjs.Shape();
	this.shape_70.graphics.f().s("rgba(255,255,255,0.224)").ss(2.5,1,1).p("A2CAAQAAgwGdgkQGdgjJIAAQJIAAGeAjQGdAkAAAwQAAAxmdAkQmeAjpIAAQpIAAmdgjQmdgkAAgxg");
	this.shape_70.setTransform(39.2,273.1);

	this.shape_71 = new cjs.Shape();
	this.shape_71.graphics.f().s("rgba(255,255,255,0.192)").ss(2.5,1,1).p("A3PAAQAAgzG0gmQG0glJnAAQJoAAG0AlQG0AmAAAzQAAA0m0AlQm0AmpoAAQpnAAm0gmQm0glAAg0g");
	this.shape_71.setTransform(39.4,273.1);

	this.shape_72 = new cjs.Shape();
	this.shape_72.graphics.f().s("rgba(255,255,255,0.161)").ss(2.6,1,1).p("A4bAAQAAg2HJgnQHLgnKHAAQKIAAHKAnQHKAnAAA2QAAA3nKAnQnKAnqIAAQqHAAnLgnQnJgnAAg3g");
	this.shape_72.setTransform(39.7,273.1);

	this.shape_73 = new cjs.Shape();
	this.shape_73.graphics.f().s("rgba(255,255,255,0.129)").ss(2.7,1,1).p("A5oAAQAAg5HggpQHhgpKnAAQKoAAHgApQHhApAAA5QAAA5nhApQngAqqoAAQqnAAnhgqQnggpAAg5g");
	this.shape_73.setTransform(40,273.1);

	this.shape_74 = new cjs.Shape();
	this.shape_74.graphics.f().s("rgba(255,255,255,0.094)").ss(2.8,1,1).p("A61AAQAAg7H3grQH3grLHAAQLHAAH3ArQH4ArAAA7QAAA8n4ArQn3ArrHAAQrHAAn3grQn3grAAg8g");
	this.shape_74.setTransform(40.3,273.1);

	this.shape_75 = new cjs.Shape();
	this.shape_75.graphics.f().s("rgba(255,255,255,0.063)").ss(2.9,1,1).p("A8CAAQAAg+IOgtQINgtLnAAQLnAAIOAtQIOAtAAA+QAAA/oOAtQoOAtrnAAQrnAAoNgtQoOgtAAg/g");
	this.shape_75.setTransform(40.6,273.1);

	this.shape_76 = new cjs.Shape();
	this.shape_76.graphics.f().s("rgba(255,255,255,0.031)").ss(2.9,1,1).p("A9OAAQAAhBIjgvQIkguMHAAQMHAAIkAuQIkAvAABBQAABCokAuQokAvsHAAQsHAAokgvQojguAAhCg");
	this.shape_76.setTransform(40.9,273.1);

	this.shape_77 = new cjs.Shape();
	this.shape_77.graphics.f().s("rgba(255,255,255,0)").ss(3,1,1).p("AVhB1Qo7AxsmAAQsmAAo7gxQo6gxAAhEQAAhDI6gxQI7gxMmAAQMmAAI7AxQI7AxAABDQAABEo7Axg");
	...
	this.shape_78.graphics.f().s("rgba(255,255,255,0.8)").ss(1,1,1).p("AAWgBQAJABAAAAQAAABgJABQgJABgNAAQgMAAgJgBQgJgBAAgBQAAAAAJgBQAJgBAMAAQANAAAJABg");
	this.shape_78.setTransform(34.1,273.1);

	this.shape_79 = new cjs.Shape();
	this.shape_79.graphics.f().s("rgba(255,255,255,0.769)").ss(1.1,1,1).p("AhrAAQAAgDAggDQAfgCAsAAQAtAAAfACQAgADAAADQAAADggADQgfADgtAAQgsAAgfgDQgggDAAgDg");
	this.shape_79.setTransform(34.4,273.1);

	this.shape_80 = new cjs.Shape();
	this.shape_80.graphics.f().s("rgba(255,255,255,0.737)").ss(1.2,1,1).p("Ai3AAQAAgGA1gEQA2gFBMAAQBMAAA2AFQA2AEAAAGQAAAGg2AFQg2AEhMAAQhMAAg2gEQg1gFAAgGg");
	this.shape_80.setTransform(34.7,273.1);

	this.shape_81 = new cjs.Shape();
	this.shape_81.graphics.f().s("rgba(255,255,255,0.706)").ss(1.3,1,1).p("AkEAAQAAgIBMgHQBNgGBrAAQBsAABNAGQBMAHAAAIQAAAJhMAHQhNAGhsAAQhrAAhNgGQhMgHAAgJg");
	this.shape_81.setTransform(35,273.1);

	this.shape_82 = new cjs.Shape();
	this.shape_82.graphics.f().s("rgba(255,255,255,0.671)").ss(1.3,1,1).p("AlRAAQAAgLBjgJQBjgICLAAQCMAABjAIQBjAJAAALQAAAMhjAIQhjAIiMAAQiLAAhjgIQhjgIAAgMg");
	this.shape_82.setTransform(35.2,273.1);

	this.shape_83 = new cjs.Shape();
	this.shape_83.graphics.f().s("rgba(255,255,255,0.639)").ss(1.4,1,1).p("AmeAAQAAgOB6gKQB5gKCrAAQCsAAB5AKQB6AKAAAOQAAAOh6ALQh5AKisAAQirAAh5gKQh6gLAAgOg");
	this.shape_83.setTransform(35.5,273.1);

	this.shape_84 = new cjs.Shape();
	this.shape_84.graphics.f().s("rgba(255,255,255,0.608)").ss(1.5,1,1).p("AnqAAQAAgQCPgNQCQgMDLAAQDLAACQAMQCQANAAAQQAAARiQAMQiQAMjLAAQjLAAiQgMQiPgMAAgRg");
	this.shape_84.setTransform(35.8,273.1);

	this.shape_85 = new cjs.Shape();
	this.shape_85.graphics.f().s("rgba(255,255,255,0.576)").ss(1.6,1,1).p("Ao3AAQAAgTCmgOQCngODqAAQDrAACmAOQCnAOAAATQAAAUinAOQimAOjrAAQjqAAingOQimgOAAgUg");
	this.shape_85.setTransform(36.1,273.1);

	this.shape_86 = new cjs.Shape();
	this.shape_86.graphics.f().s("rgba(255,255,255,0.545)").ss(1.7,1,1).p("AqEAAQAAgWC9gQQC9gQEKAAQELAAC9AQQC8AQAAAWQAAAWi8ARQi9AQkLAAQkKAAi9gQQi9gRAAgWg");
	this.shape_86.setTransform(36.4,273.1);

	this.shape_87 = new cjs.Shape();
	this.shape_87.graphics.f().s("rgba(255,255,255,0.514)").ss(1.7,1,1).p("ArQAAQAAgYDTgTQDTgREqAAQErAADTARQDTATAAAYQAAAZjTASQjTASkrAAQkqAAjTgSQjTgSAAgZg");
	this.shape_87.setTransform(36.7,273.1);

	this.shape_88 = new cjs.Shape();
	this.shape_88.graphics.f().s("rgba(255,255,255,0.478)").ss(1.8,1,1).p("AsdAAQAAgbDqgUQDpgUFKAAQFKAADqAUQDqAUAAAbQAAAcjqAUQjqAUlKAAQlKAAjpgUQjqgUAAgcg");
	this.shape_88.setTransform(36.9,273.1);

	this.shape_89 = new cjs.Shape();
	this.shape_89.graphics.f().s("rgba(255,255,255,0.447)").ss(1.9,1,1).p("AtqAAQAAgeEAgWQEAgVFqAAQFqAAEAAVQEBAWAAAeQAAAekBAWQkAAWlqAAQlqAAkAgWQkAgWAAgeg");
	this.shape_89.setTransform(37.2,273.1);

	this.shape_90 = new cjs.Shape();
	this.shape_90.graphics.f().s("rgba(255,255,255,0.416)").ss(2,1,1).p("Au2AAQAAggEWgYQEXgYGJAAQGKAAEWAYQEXAYAAAgQAAAhkXAYQkWAYmKAAQmJAAkXgYQkWgYAAghg");
	this.shape_90.setTransform(37.5,273.1);

	this.shape_91 = new cjs.Shape();
	this.shape_91.graphics.f().s("rgba(255,255,255,0.384)").ss(2.1,1,1).p("AwDAAQAAgjEtgaQEtgaGpAAQGqAAEtAaQEtAaAAAjQAAAkktAaQktAamqAAQmpAAktgaQktgaAAgkg");
	this.shape_91.setTransform(37.8,273.1);

	this.shape_92 = new cjs.Shape();
	this.shape_92.graphics.f().s("rgba(255,255,255,0.353)").ss(2.1,1,1).p("AxPAAQAAgmFDgcQFDgbHJAAQHJAAFEAbQFDAcAAAmQAAAnlDAbQlEAcnJAAQnJAAlDgcQlDgbAAgng");
	this.shape_92.setTransform(38,273.1);

	this.shape_93 = new cjs.Shape();
	this.shape_93.graphics.f().s("rgba(255,255,255,0.322)").ss(2.2,1,1).p("AycAAQAAgoFZgeQFageHpAAQHpAAFaAeQFaAeAAAoQAAAplaAeQlaAdnpAAQnpAAlagdQlZgeAAgpg");
	this.shape_93.setTransform(38.3,273.1);

	this.shape_94 = new cjs.Shape();
	this.shape_94.graphics.f().s("rgba(255,255,255,0.286)").ss(2.3,1,1).p("AzpAAQAAgrFxggQFwgfIIAAQIJAAFwAfQFxAgAAArQAAAslxAfQlwAgoJAAQoIAAlwggQlxgfAAgsg");
	this.shape_94.setTransform(38.6,273.1);

	this.shape_95 = new cjs.Shape();
	this.shape_95.graphics.f().s("rgba(255,255,255,0.255)").ss(2.4,1,1).p("A01AAQAAguGGghQGHgiIoAAQIoAAGHAiQGHAhAAAuQAAAvmHAhQmHAhooAAQooAAmHghQmGghAAgvg");
	this.shape_95.setTransform(38.9,273.1);

	this.shape_96 = new cjs.Shape();
	this.shape_96.graphics.f().s("rgba(255,255,255,0.224)").ss(2.5,1,1).p("A2CAAQAAgwGdgkQGdgjJIAAQJIAAGeAjQGdAkAAAwQAAAxmdAkQmeAjpIAAQpIAAmdgjQmdgkAAgxg");
	this.shape_96.setTransform(39.2,273.1);

	this.shape_97 = new cjs.Shape();
	this.shape_97.graphics.f().s("rgba(255,255,255,0.192)").ss(2.5,1,1).p("A3PAAQAAgzG0gmQG0glJnAAQJoAAG0AlQG0AmAAAzQAAA0m0AlQm0AmpoAAQpnAAm0gmQm0glAAg0g");
	this.shape_97.setTransform(39.4,273.1);

	this.shape_98 = new cjs.Shape();
	this.shape_98.graphics.f().s("rgba(255,255,255,0.161)").ss(2.6,1,1).p("A4bAAQAAg2HJgnQHLgnKHAAQKIAAHKAnQHKAnAAA2QAAA3nKAnQnKAnqIAAQqHAAnLgnQnJgnAAg3g");
	this.shape_98.setTransform(39.7,273.1);

	this.shape_99 = new cjs.Shape();
	this.shape_99.graphics.f().s("rgba(255,255,255,0.129)").ss(2.7,1,1).p("A5oAAQAAg5HggpQHhgpKnAAQKoAAHgApQHhApAAA5QAAA5nhApQngAqqoAAQqnAAnhgqQnggpAAg5g");
	this.shape_99.setTransform(40,273.1);

	this.shape_100 = new cjs.Shape();
	this.shape_100.graphics.f().s("rgba(255,255,255,0.094)").ss(2.8,1,1).p("A61AAQAAg7H3grQH3grLHAAQLHAAH3ArQH4ArAAA7QAAA8n4ArQn3ArrHAAQrHAAn3grQn3grAAg8g");
	this.shape_100.setTransform(40.3,273.1);

	this.shape_101 = new cjs.Shape();
	this.shape_101.graphics.f().s("rgba(255,255,255,0.063)").ss(2.9,1,1).p("A8CAAQAAg+IOgtQINgtLnAAQLnAAIOAtQIOAtAAA+QAAA/oOAtQoOAtrnAAQrnAAoNgtQoOgtAAg/g");
	this.shape_101.setTransform(40.6,273.1);

	this.shape_102 = new cjs.Shape();
	this.shape_102.graphics.f().s("rgba(255,255,255,0.031)").ss(2.9,1,1).p("A9OAAQAAhBIjgvQIkguMHAAQMHAAIkAuQIkAvAABBQAABCokAuQokAvsHAAQsHAAokgvQojguAAhCg");
	this.shape_102.setTransform(40.9,273.1);

	this.shape_103 = new cjs.Shape();
	this.shape_103.graphics.f().s("rgba(255,255,255,0)").ss(3,1,1).p("AVhB1Qo7AxsmAAQsmAAo7gxQo6gxAAhEQAAhDI6gxQI7gxMmAAQMmAAI7AxQI7AxAABDQAABEo7Axg");
...
(lib.flowerStem = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#87835C","#54541F","#464012"],[0,0.329,1],-12.4,0,12.5,0).s().p("AAvR0QgrgBgkgZQgpgbgLgrQgUhNgHjdQgChEAAhnIgBhxQAAhagKqwQgBhjAKjYQALjzAOg6QAMgvAJhdQAGg4ARgGQAYgJAiAFQAiAFAkASQAgAQAIAaQAGATgJAgQgFARgbAHQgdAIgMAaQgTAmgQBOQgQBQADAoIAHKzQAEGxAGCzQADBgAEAXQAIA4AGBeQAOBXA3BxQAXAwgUAaQgSAWgoAAIgDAAg");
...
(lib.flowerHead = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#A29A74","#76723E","#656333","#4E4D24"],[0,0.498,0.69,1],7.4,0,-7.4,0).s().p("AgYAiQgVgDgKgVIgTgNIAZADQAcACAVgCQAUgBAPgOIAUgSQAMgGAGASQAFATgMAPQgLAQggAEQgPADgMAAQgLAAgJgCg");
	this.shape.setTransform(13.5,17.7,1.603,1.603);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.lf(["#A29A74","#76723E","#656333","#4E4D24"],[0,0.498,0.69,1],-8.1,-2.1,9.1,1.9).s().p("AgaBJQgMgEgQgYQgOgWgIgXQgHgSAHgQQAHgNANgHQAIgEAHgLQAIgNAHgFQAIgGAcANQAiAQAGAAQANACAKApQAHAgAAAWIABAiQgDAWgSABIgHAAQgdAAgygRg");
	this.shape_1.setTransform(-13.7,1,1.603,1.603);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.rf(["#FCF3DD","#FDEDC1","#FFE18A","#FFCD03","#F7C50D","#E2B124"],[0,0,0,0.549,0.667,1],0,0,0,0,0,12.2).s().p("AAGBwQgSgBgKgVQgLgWgMgDIg3gPQgSgFgIgoQgGgcACgYQgBgbACgDQABgCAUgGQASgIACAAQAGAAAGgBQANgDALACIAiAKQARAEALgIQAOgJARABQAVACAGAKIACAEIABgEIABgUQAAgJAJAEQAOAGAUA7QAWA/gIAiQgJAigsAQQgdAKgdAAIgMAAg");
	this.shape_2.setTransform(7.3,3.6,1.603,1.603);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.rf(["#FCF3DD","#FDEDC1","#FFE18A","#FFCD03","#F7C50D","#E2B124"],[0,0,0,0.549,0.667,1],0,0,0,0,0,8.5).s().p("AgNBRQg4gGgHgTQgGgMgEgOQgGgeAQgNQAMgLAVgYQAVgVAZgJQAjgLAdAbQAYAXgDAQQgDANgcBCQgJAagtAAIgQgBg");
	this.shape_3.setTransform(-14.2,-10.3,1.603,1.603);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.rf(["#FCF3DD","#F2E0AF","#E6C978","#E6AD03","#E5A60D","#E29424"],[0,0,0,0.533,0.655,1],0,0,0,0,0,9).s().p("Ag0AMQhAhEAWgLQAegPAZAFIArAHQAcADAEAFQAEAEAeASQAdAVABATQACAagOAYQgQAcgdABIgCAAQggAAg9hDg");
...
(lib.Tween1 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#2F5326").s().p("");
	this.shape.setTransform(-33.6,-18.7);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#274B20").s().p("");
	this.shape_1.setTransform(-38.9,-22.9);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#365B2C").s().p("");
	this.shape_2.setTransform(-27.4,-14.6);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#3D6431").s().p("");
	this.shape_3.setTransform(-21.4,-10.6);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#446C36").s().p("");
	this.shape_4.setTransform(-15.7,-6.1);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#4B753B").s().p("");
	this.shape_5.setTransform(-9.7,-9.8);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#588545").s().p("");
...
(lib.nupharleaf_01 = function(mode,startPosition,loop) {
	...
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#365B2C").s().p("");
	this.shape_1.setTransform(171.2,78.4);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#3D6431").s().p("");
	this.shape_2.setTransform(177.2,82.4);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#446C36").s().p("");
	this.shape_3.setTransform(182.9,86.9);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#4B753B").s().p("");
	this.shape_4.setTransform(189,83.2);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#588545").s().p("");
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	// nuphar-mc
	this.instance = new lib.Nuphar_mc("synched",45,false);
	this.instance.parent = this;
	this.instance.setTransform(1015.2,607.5,1.817,1.817,0,0,0,544.5,381.7);
	this.instance.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({regX:542.5,regY:384,x:1011.6,y:611.7,alpha:0.111,startPosition:46},0).wait(1).to({alpha:0.222,startPosition:47},0).wait(1).to({alpha:0.333,startPosition:48},0).wait(1).to({alpha:0.444,startPosition:49},0).wait(1).to({alpha:0.556,startPosition:50},0).wait(1).to({alpha:0.667,startPosition:51},0).wait(1).to({alpha:0.778,startPosition:52},0).wait(1).to({alpha:0.889,startPosition:53},0).wait(1).to({alpha:1,startPosition:54},0).wait(1).to({regX:544.5,regY:382.8,x:1015.2,y:607.4,startPosition:55},0).wait(1).to({regX:542.5,regY:384,x:1011.6,y:609.6,startPosition:56},0).wait(1).to({startPosition:57},0).wait(1).to({startPosition:58},0).wait(1).to({startPosition:59},0).wait(1).to({startPosition:60},0).wait(1).to({startPosition:61},0).wait(1).to({startPosition:62},0).wait(1).to({startPosition:63},0).wait(1).to({startPosition:64},0).wait(1).to({startPosition:65},0).wait(1).to({startPosition:66},0).wait(1).to({startPosition:67},0).wait(1).to({startPosition:68},0).wait(1).to({startPosition:69},0).wait(1).to({startPosition:70},0).wait(1).to({startPosition:71},0).wait(1).to({startPosition:72},0).wait(1).to({startPosition:73},0).wait(1).to({startPosition:74},0).wait(1).to({startPosition:75},0).wait(1).to({startPosition:76},0).wait(1).to({startPosition:77},0).wait(1).to({startPosition:78},0).wait(1).to({startPosition:79},0).wait(1).to({startPosition:80},0).wait(1).to({startPosition:81},0).wait(1).to({startPosition:82},0).wait(1).to({startPosition:83},0).wait(1).to({startPosition:84},0).wait(1).to({startPosition:85},0).wait(1).to({startPosition:86},0).wait(1).to({startPosition:87},0).wait(1).to({startPosition:88},0).wait(1).to({startPosition:89},0).wait(1).to({startPosition:90},0).wait(1).to({startPosition:91},0).wait(1).to({startPosition:92},0).wait(1).to({startPosition:93},0).wait(1).to({startPosition:94},0).wait(1).to({startPosition:95},0).wait(1).to({startPosition:96},0).wait(1).to({startPosition:97},0).wait(1).to({startPosition:98},0).wait(1).to({startPosition:99},0).wait(1).to({startPosition:100},0).wait(1).to({startPosition:101},0).wait(1).to({startPosition:102},0).wait(1).to({startPosition:103},0).wait(1).to({startPosition:104},0).wait(1).to({startPosition:105},0).wait(1).to({startPosition:106},0).wait(1).to({startPosition:107},0).wait(1).to({startPosition:108},0).wait(1).to({startPosition:109},0).wait(1).to({startPosition:110},0).wait(1).to({startPosition:111},0).wait(1).to({startPosition:112},0).wait(1).to({startPosition:113},0).wait(1).to({alpha:0.875,startPosition:114},0).wait(1).to({alpha:0.75,startPosition:115},0).wait(1).to({alpha:0.625,startPosition:116},0).wait(1).to({alpha:0.5,startPosition:117},0).wait(1).to({alpha:0.375,startPosition:118},0).wait(1).to({alpha:0.25,startPosition:119},0).wait(1).to({alpha:0.125,startPosition:120},0).wait(1).to({alpha:0,startPosition:121},0).to({_off:true},1).wait(163));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(788.8,414.6,2268.2,1474.1);
// library properties:
lib.properties = {
	width: 1920,
	height: 1080,
