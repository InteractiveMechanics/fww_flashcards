...
(lib.osprey_Head = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#666666").ss(1,0,0,4).p("AjFhFQAuAGCLADQB9AJAyAsQATAOAHAMQALARgCASIAAgCQgZAEggACQg/ADgigOQgmgQg9gEIg3AAQgEgUgrgSQgogTAAgng");
	this.shape.setTransform(170.3,69);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#2A1B2C").s().p("AAsA0QgmgQg9gDIg3gBQgEgUgrgSQgogTAAgmQAuAGCLACQB9AJAyAsQATAOAHANQALAQgCATIAAgDQgZAFggABIgVABQgwAAgcgMg");
	this.shape_1.setTransform(170.3,68.5);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f().s("#666666").ss(1,0,0,4).p("AjagQQAuAGCLACQB9AIAzArIANARQAOAVAIAXQAMAmgFA3QANgWAJgfQAUg9gNgqQgKgngHgWQgOgsgTgfQg5hdh3gWQgRA4glAdQgYAUgsANQgvAOgMAIQgZAQAAAmg");
	this.shape_2.setTransform(172.4,64.1);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#2A1B2C").s().p("ACyBvQgIgXgOgVIgNgRQgzgsh9gHQiLgCgugGQAAgmAZgQQAMgIAvgOQAsgNAYgUQAlgdARg4QB3AWA5BdQATAfAOAsIARA9QANAqgUA9QgJAfgNAWQAFg3gMgmg");
	this.shape_3.setTransform(172.4,63.4);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#000000").s().p("AgQARQgIgHAAgKQAAgJAIgHQAHgIAJAAQAKAAAHAIQAIAHAAAJQAAAKgIAHQgHAIgKAAQgJAAgHgIg");
	this.shape_4.setTransform(147.9,45.5);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f().s("#000000").ss(3,0,0,4).p("ABIAAQAAAegVAVQgVAVgeAAQgdAAgVgVQgVgVAAgeQAAgdAVgUQAVgWAdAAQAeAAAVAWQAVAUAAAdg");
	this.shape_5.setTransform(148,45.5);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.rf(["#FFFACB","#FAF1BA","#EFD88D","#EDD587","#EABA10","#C2912E"],[0,0.114,0.341,0.373,0.686,1],0,0,0,0,0,7.3).s().p("AgyAzQgVgVAAgeQAAgcAVgWQAVgVAdAAQAeAAAVAVQAVAWAAAcQAAAegVAVQgVAVgeAAQgdAAgVgVg");
	this.shape_6.setTransform(148,45.5);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FCF8EE").s().p("");
	this.shape_7.setTransform(86,57.1);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#B4B2BE").s().p("");
	this.shape_8.setTransform(85.1,58.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	// Layer 2
	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f().s("#CCCCCC").ss(1,1,0,4,true).p("ALJhBQgjgrgygvQhjhfhHgPQhHgPhCgVQgygSAAAAQgRgIgxgEQhigJiaAYQgyAHhngqQhzgvgPgCQhvgMg+g2QgKgJgOgQQgCgCAFAOQATA/hEB0QhBBugoAFQgiAFABAMQABAMAjAYQAlAZAeBKQAgBNgTAqQgYA1AEBDQAGBSAzA8QBHBTBNAiQBqAuCBghQCOgkC/heQDAheAyg4QAlgpCKhuQCEhmAGgKg");
	this.shape_9.setTransform(100.3,51);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#2C1214").s().p("AmaHRQhNgihHhTQgzg8gGhSQgEhDAYg1QATgqgghNQgehKglgZQgjgYgBgMQgBgMAigFQAogFBBhuQBEh0gTg/QgFgOACACQAOAQAKAJQA+A2BvAMQAPACBzAvQBnAqAygHQCagYBiAJQAxAEARAIIAyASQBCAVBHAPQBHAPBjBfQAyAvAjArQgGAKiEBmQiKBuglApQgyA4jABeQi/BeiOAkQg2AOgyAAQhFAAg+gbg");
...
p.nominalBounds = new cjs.Rectangle(-1,0,186,214.2);
...
(lib.Osprey = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(35.1,461.9,0.364,0.273,0,34.2,-148);
	...
	this.shape_1.setTransform(22.4,459.2,0.364,0.273,0,34.2,-148);
	...
	this.shape_2.setTransform(77.8,478.3,0.364,0.273,0,34.2,-148);
	...
	this.shape_3.setTransform(77.8,478.3,0.364,0.273,0,34.2,-148);
	...
	this.shape_4.setTransform(77.8,478.3,0.364,0.273,0,34.2,-148);

	this.instance_5 = new lib.mouth();
	this.instance_5.setTransform(-5.7,446.8,0.62,0.465,0,32.2,-149.1,101.4,-4.8);

	this.instance_6 = new lib.sideFin("synched",0);
	this.instance_6.setTransform(-22.5,471.6,0.62,0.466,0,34.2,-148,-58.8,2.5);

	this.instance_7 = new lib.Path_18();
	this.instance_7.setTransform(-56.4,497.4,0.364,0.273,0,34.2,-148,16.3,19.7);
	this.instance_7.alpha = 0.449;

	this.instance_8 = new lib.Path_1_3();
	this.instance_8.setTransform(-58,502,0.364,0.273,0,34.2,-148,24.4,31.8);
	this.instance_8.alpha = 0.449;

	this.instance_9 = new lib.Path_2_3();
	this.instance_9.setTransform(-57,505.7,0.364,0.273,0,34.2,-148,32.2,40.4);
	this.instance_9.alpha = 0.449;

	this.instance_10 = new lib.Path_3_3();
	this.instance_10.setTransform(-58.3,510,0.364,0.273,0,34.2,-148,32.7,42.7);
	this.instance_10.alpha = 0.449;

	this.instance_11 = new lib.Path_4_3();
	this.instance_11.setTransform(-55.9,514.1,0.364,0.273,0,34.2,-148,28.9,37);
	this.instance_11.alpha = 0.449;

	this.instance_12 = new lib.Path_5_4();
	this.instance_12.setTransform(-52.7,508,0.364,0.273,0,34.2,-148,48.1,60.5);
	this.instance_12.alpha = 0.578;

	this.instance_13 = new lib.Path_6_3();
	this.instance_13.setTransform(-53.7,508.7,0.364,0.273,0,34.2,-148,54.6,67.6);
	this.instance_13.alpha = 0.73;

	this.instance_14 = new lib.Path_19();
	this.instance_14.setTransform(-98.7,423.1,0.364,0.273,0,34.2,-148,21,31.4);
	this.instance_14.alpha = 0.559;

	this.instance_15 = new lib.Path_1_4();
	this.instance_15.setTransform(-61.5,421.4,0.364,0.273,0,34.2,-148,22,54.8);
	this.instance_15.alpha = 0.559;

	this.instance_16 = new lib.Path_2_4();
	this.instance_16.setTransform(-43.2,422.3,0.364,0.273,0,34.2,-148,20.8,52);
	this.instance_16.alpha = 0.559;

	this.instance_17 = new lib.Path_3_4();
	this.instance_17.setTransform(-81.4,417.9,0.364,0.273,0,34.2,-148,21.9,36.4);
	this.instance_17.alpha = 0.559;

	this.instance_18 = new lib.Path_4_4();
	this.instance_18.setTransform(-22.1,426,0.364,0.273,0,34.2,-148,20.7,43.4);
	this.instance_18.alpha = 0.559;

	this.instance_19 = new lib.Path_5_5();
	this.instance_19.setTransform(-4.3,431.8,0.364,0.273,0,34.2,-148,18.6,39.9);
	this.instance_19.alpha = 0.559;

	this.instance_20 = new lib.Path_8_1();
	this.instance_20.setTransform(-144.1,442.2,0.364,0.273,0,34.2,-148,65.1,147.5);
	this.instance_20.alpha = 0.559;

	this.instance_21 = new lib.Path_17();
	this.instance_21.setTransform(59.7,458,0.364,0.273,0,34.2,-148,18.7,13.2);
	this.instance_21.alpha = 0.988;

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AhUAQQgLgjARgcICoARIifBOQgJgOgGgSg");
	this.shape_5.setTransform(62.3,456.4,0.364,0.273,0,34.2,-148);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#231F20").s().p("AhfBUQgpgjAAgxQAAgwApgjQAogjA3AAQA4AAApAjQAoAjAAAwQAAAxgoAjQgpAjg4AAQg3AAgogjg");
	this.shape_6.setTransform(60.8,455.1,0.364,0.273,0,34.2,-148);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFF799").s().p("AiBBxQg2gvABhCQgBhBA2gvQA2gvBLAAQBMAAA2AvQA2AvAABBQAABCg2AvQg2AvhMAAQhLAAg2gvg");
	this.shape_7.setTransform(60.8,455.1,0.364,0.273,0,34.2,-148);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#231F20").s().p("AiTCBQg+g1AAhMQAAhKA+g2QA9g2BWAAQBXAAA9A2QA+A2AABKQAABMg+A1Qg9A2hXAAQhWAAg9g2g");
	this.shape_8.setTransform(60.8,455.1,0.364,0.273,0,34.2,-148);

	this.instance_22 = new lib.Path_5_3();
	this.instance_22.setTransform(62.7,453.8,0.364,0.273,0,34.2,-148,19.1,12.1);
	this.instance_22.alpha = 0.988;

	this.instance_23 = new lib.Path_11_1();
	this.instance_23.setTransform(84.9,486.9,0.364,0.273,0,34.2,-148,62.5,83.2);
	this.instance_23.alpha = 0.781;
	...
	this.shape_9.setTransform(-40.4,478.3,0.364,0.273,0,34.2,-148);

	this.instance_24 = new lib.Path_14();
	this.instance_24.setTransform(-124,484.1,0.364,0.273,0,34.2,-148,7.9,13.4);
	this.instance_24.alpha = 0.449;

	this.instance_25 = new lib.Path_1_0();
	this.instance_25.setTransform(-133.8,489.5,0.364,0.273,0,34.2,-148,9.3,28.1);
	this.instance_25.alpha = 0.449;

	this.instance_26 = new lib.Path_2_0();
	this.instance_26.setTransform(-146.3,490.4,0.364,0.273,0,34.2,-148,6.9,47);
	this.instance_26.alpha = 0.449;

	this.instance_27 = new lib.Path_3_0();
	this.instance_27.setTransform(-155.2,486.8,0.364,0.273,0,34.2,-148,10.4,42.2);
	this.instance_27.alpha = 0.449;

	this.instance_28 = new lib.Path_4_0();
	this.instance_28.setTransform(-159.8,483.4,0.364,0.273,0,34.2,-148,7.9,32.1);
	this.instance_28.alpha = 0.449;

	this.instance_29 = new lib.Path_5_0();
	this.instance_29.setTransform(-141.2,485.8,0.364,0.273,0,34.2,-148,44.2,79.5);
	this.instance_29.alpha = 0.578;

	this.instance_30 = new lib.Path_6_0();
	this.instance_30.setTransform(-156.1,478.5,0.364,0.273,0,34.2,-148,8.7,22.7);
	this.instance_30.alpha = 0.578;

	this.instance_31 = new lib.Path_7_0();
	this.instance_31.setTransform(-141.8,485.3,0.364,0.273,0,34.2,-148,55.8,91.4);
	this.instance_31.alpha = 0.73;

	this.instance_32 = new lib.Path_15();
	this.instance_32.setTransform(-31.2,518.1,0.364,0.273,0,34.2,-148,5,23.2);
	this.instance_32.alpha = 0.449;

	this.instance_33 = new lib.Path_1_1();
	this.instance_33.setTransform(-30.7,522.9,0.364,0.273,0,34.2,-148,5.5,36.8);
	this.instance_33.alpha = 0.449;

	this.instance_34 = new lib.Path_2_1();
	this.instance_34.setTransform(-28.8,526.1,0.364,0.273,0,34.2,-148,7.1,47.2);
	this.instance_34.alpha = 0.449;

	this.instance_35 = new lib.Path_3_1();
	this.instance_35.setTransform(-27.8,530.1,0.364,0.273,0,34.2,-148,5.9,47.7);
	this.instance_35.alpha = 0.449;

	this.instance_36 = new lib.Path_4_1();
	this.instance_36.setTransform(-24.8,533.4,0.364,0.273,0,34.2,-148,4.5,42.5);
	this.instance_36.alpha = 0.449;

	this.instance_37 = new lib.Path_5_1();
	this.instance_37.setTransform(-26.9,525.6,0.364,0.273,0,34.2,-148,18.8,66.7);
	this.instance_37.alpha = 0.578;

	this.instance_38 = new lib.Path_6_1();
	this.instance_38.setTransform(-28.2,525.7,0.364,0.273,0,34.2,-148,25.4,76.2);
	this.instance_38.alpha = 0.73;

	this.instance_39 = new lib.Path_0();
	this.instance_39.setTransform(-149.3,427,0.358,0.253,0,36.7,-149.9,12.2,12.3);
	this.instance_39.alpha = 0.449;

	this.instance_40 = new lib.Path_1();
	this.instance_40.setTransform(-144.3,423.3,0.358,0.253,0,36.7,-149.9,21.3,20.5);
	this.instance_40.alpha = 0.449;

	this.instance_41 = new lib.Path_2();
	this.instance_41.setTransform(-139.2,418.8,0.358,0.253,0,36.7,-149.9,23.9,14.2);
	this.instance_41.alpha = 0.449;

	this.instance_42 = new lib.Path_3();
	this.instance_42.setTransform(-129.3,416.6,0.358,0.253,0,36.7,-149.9,35.2,18.8);
	this.instance_42.alpha = 0.449;

	this.instance_43 = new lib.Path_4();
	this.instance_43.setTransform(-123.1,413.2,0.358,0.253,0,36.7,-149.9,42.2,13);
	this.instance_43.alpha = 0.449;

	this.instance_44 = new lib.Path_5();
	this.instance_44.setTransform(-115.6,410.8,0.358,0.253,0,36.7,-149.9,42.1,16.5);
	this.instance_44.alpha = 0.449;

	this.instance_45 = new lib.Path_6();
	this.instance_45.setTransform(-103.9,410.4,0.358,0.253,0,36.7,-149.9,34.2,16.2);
	this.instance_45.alpha = 0.449;

	this.instance_46 = new lib.Path_7();
	this.instance_46.setTransform(-86.7,410.7,0.358,0.253,0,36.7,-149.9,21.2,18.2);
	this.instance_46.alpha = 0.449;

	this.instance_47 = new lib.Path_8();
	this.instance_47.setTransform(-76.1,406.9,0.358,0.253,0,36.7,-149.9,20,21.6);
	this.instance_47.alpha = 0.449;

	this.instance_48 = new lib.Path_9();
	this.instance_48.setTransform(-64.8,404.5,0.358,0.253,0,36.7,-149.9,27.2,30.4);
	this.instance_48.alpha = 0.449;

	this.instance_49 = new lib.Path_10();
	this.instance_49.setTransform(-57,401.1,0.358,0.253,0,36.7,-149.9,36.8,34.4);
	this.instance_49.alpha = 0.449;

	this.instance_50 = new lib.Path_11();
	this.instance_50.setTransform(-46.1,400.9,0.358,0.253,0,36.7,-149.9,33.5,50.2);
	this.instance_50.alpha = 0.449;

	this.instance_51 = new lib.Path_12();
	this.instance_51.setTransform(-28.2,410.1,0.358,0.253,0,36.7,-149.9,14.2,30.8);
	this.instance_51.alpha = 0.449;

	this.instance_52 = new lib.Path_13();
	this.instance_52.setTransform(-37.5,397.5,0.358,0.253,0,36.7,-149.9,32.9,48);
	this.instance_52.alpha = 0.449;

	this.instance_53 = new lib.Group();
	this.instance_53.setTransform(-81.9,414.1,0.358,0.253,0,36.7,-149.9,146.3,183.5);
	this.instance_53.alpha = 0.609;

	this.instance_54 = new lib.Path();
	this.instance_54.setTransform(-82.3,414.4,0.358,0.253,0,36.7,-149.9,151.5,202.1);
	this.instance_54.alpha = 0.73;

	this.instance_55 = new lib.tailFin();
	this.instance_55.setTransform(-182.5,471.6,0.719,0.466,0,34.2,-176.4,19.4,66.4);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_55},{t:this.instance_54},{t:this.instance_53},{t:this.instance_52},{t:this.instance_51},{t:this.instance_50},{t:this.instance_49},{t:this.instance_48},{t:this.instance_47},{t:this.instance_46},{t:this.instance_45},{t:this.instance_44},{t:this.instance_43},{t:this.instance_42},{t:this.instance_41},{t:this.instance_40},{t:this.instance_39},{t:this.instance_38},{t:this.instance_37},{t:this.instance_36},{t:this.instance_35},{t:this.instance_34},{t:this.instance_33},{t:this.instance_32},{t:this.instance_31},{t:this.instance_30},{t:this.instance_29},{t:this.instance_28},{t:this.instance_27},{t:this.instance_26},{t:this.instance_25},{t:this.instance_24},{t:this.shape_9},{t:this.instance_23},{t:this.instance_22},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.instance_21},{t:this.instance_20},{t:this.instance_19},{t:this.instance_18},{t:this.instance_17},{t:this.instance_16},{t:this.instance_15},{t:this.instance_14},{t:this.instance_13},{t:this.instance_12},{t:this.instance_11},{t:this.instance_10},{t:this.instance_9},{t:this.instance_8},{t:this.instance_7},{t:this.instance_6},{t:this.instance_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(70));

	// ospreyLeg_L
	this.instance_56 = new lib.ospreyLeg_L("synched",0);
	this.instance_56.setTransform(-6.8,358.6,1,1,0,0,0,92.2,107);

	this.timeline.addTween(cjs.Tween.get(this.instance_56).wait(70));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-307.4,-464.7,615.8,1011.3);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.instance.setTransform(-635.5,74.3,1,1,5.8,0,0,0.1,0.9);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({regX:0.2,regY:69,rotation:5.9,x:-531.2,y:211.1,startPosition:1},0).wait(1).to({x:-415.1,y:271.7,startPosition:2},0).wait(1).to({x:-295,y:324,startPosition:3},0).wait(1).to({rotation:5.8,x:-171.8,y:368.4,startPosition:4},0).wait(1).to({x:-46.2,y:405.5,startPosition:5},0).wait(1).to({x:81.2,y:436,startPosition:6},0).wait(1).to({x:209.9,y:460.8,startPosition:7},0).wait(1).to({rotation:0,skewX:5.7,skewY:5.7,x:339.4,y:480.5,startPosition:8},0).wait(1).to({skewY:5.6,x:469.4,y:495.8,startPosition:9},0).wait(1).to({skewX:4,skewY:3.9,x:602,y:507.6,startPosition:10},0).wait(1).to({skewX:2.3,skewY:2.2,x:734.6,y:516.2,startPosition:11},0).wait(1).to({skewX:0.6,skewY:0.5,x:867.6,y:522,startPosition:12},0).wait(1).to({skewX:0.4,skewY:0.3,x:868.6,y:518.8,startPosition:13},0).wait(1).to({skewX:0.1,skewY:0,x:869.7,y:515.6,startPosition:14},0).wait(1).to({skewX:-0.1,skewY:-0.2,x:870.7,y:512.3,startPosition:15},0).wait(1).to({skewX:-0.3,skewY:-0.4,x:871.8,y:509.1,startPosition:16},0).wait(1).to({skewX:-0.6,skewY:-0.7,x:872.8,y:505.9,startPosition:17},0).wait(1).to({skewX:-0.8,skewY:-0.9,x:877,y:507.8,startPosition:18},0).wait(1).to({skewX:-1,skewY:-1.1,x:881.3,y:509.7,startPosition:19},0).wait(1).to({skewX:-1.3,skewY:-1.4,x:885.4,y:511.6,startPosition:20},0).wait(1).to({skewX:-1.5,skewY:-1.6,x:889.7,y:513.5,startPosition:21},0).wait(1).to({skewX:-1.7,skewY:-1.9,x:893.8,y:515.4,startPosition:22},0).wait(1).to({skewX:-1.9,skewY:-2.1,x:898.1,y:517.3,startPosition:23},0).wait(1).to({skewX:-1.4,skewY:-1.5,x:894.4,y:518.7,startPosition:24},0).wait(1).to({skewX:-0.8,skewY:-0.9,x:890.8,y:520.2,startPosition:25},0).wait(1).to({skewX:-0.2,skewY:-0.4,x:887.1,y:521.6,startPosition:26},0).wait(1).to({skewX:0.4,skewY:0.2,x:883.4,y:523.1,startPosition:27},0).wait(1).to({skewX:1,skewY:0.8,x:879.8,y:524.4,startPosition:28},0).wait(1).to({skewX:1.6,skewY:1.4,x:876.1,y:525.9,startPosition:29},0).wait(1).to({skewX:2.2,skewY:2,x:872.5,y:527.3,startPosition:30},0).wait(1).to({skewX:1.9,skewY:1.7,x:874.2,y:525.3,startPosition:31},0).wait(1).to({skewX:1.7,skewY:1.5,x:875.9,y:523.3,startPosition:32},0).wait(1).to({skewX:1.4,skewY:1.2,x:877.6,y:521.4,startPosition:33},0).wait(1).to({skewX:1.2,skewY:1,x:879.3,y:519.4,startPosition:34},0).wait(1).to({skewX:1,skewY:0.7,x:881.1,y:517.4,startPosition:35},0).wait(1).to({skewX:0.7,skewY:0.5,x:882.8,y:515.4,startPosition:36},0).wait(1).to({skewX:0.5,skewY:0.2,x:884.5,y:513.4,startPosition:37},0).wait(1).to({skewX:0.2,skewY:0,x:886.2,y:511.4,startPosition:38},0).wait(1).to({skewX:0,skewY:-0.2,x:887.9,y:509.5,startPosition:39},0).wait(1).to({skewX:0.3,skewY:0.1,x:887.1,y:521.1,startPosition:40},0).wait(1).to({skewX:0.6,skewY:0.4,x:886.4,y:532.8,startPosition:41},0).wait(1).to({skewX:1,skewY:0.7,x:885.6,y:544.5,startPosition:42},0).wait(1).to({skewX:1.3,skewY:1,x:884.8,y:556.2,startPosition:43},0).wait(1).to({skewX:1.6,skewY:1.3,x:883.9,y:567.9,startPosition:44},0).wait(1).to({skewX:1.9,skewY:1.6,x:883.2,y:579.6,startPosition:45},0).wait(1).to({skewX:2.2,skewY:1.9,x:882.4,y:591.2,startPosition:46},0).wait(1).to({skewX:2.6,skewY:2.3,x:933.4,y:542.6,startPosition:47},0).wait(1).to({scaleY:1,skewX:2.9,skewY:2.6,x:984.5,y:493.9,startPosition:48},0).wait(1).to({skewX:3.2,skewY:2.9,x:1035.5,y:445.3,startPosition:49},0).wait(1).to({skewX:3,skewY:2.7,x:1048.2,y:472.2,startPosition:50},0).wait(1).to({skewX:2.8,skewY:2.5,x:1061,y:499.2,startPosition:51},0).wait(1).to({skewX:2.7,skewY:2.3,x:1073.7,y:526.1,startPosition:52},0).wait(1).to({skewX:2.5,skewY:2.2,x:1075.9,y:433,startPosition:53},0).wait(1).to({skewX:2.3,skewY:2,x:1078.2,y:339.9,startPosition:54},0).wait(1).to({skewX:2.1,skewY:1.8,x:1078.6,y:370.4,startPosition:55},0).wait(1).to({skewX:2,skewY:1.6,x:1078.9,y:401,startPosition:56},0).wait(1).to({skewX:1.8,skewY:1.4,x:1079.3,y:431.6,startPosition:57},0).wait(1).to({skewX:1.6,skewY:1.2,x:1079.6,y:462.2,startPosition:58},0).wait(1).to({skewX:1.5,skewY:1.1,x:1083.4,y:484.6,startPosition:59},0).wait(1).to({skewX:1.4,skewY:1,x:1087.1,y:507,startPosition:60},0).wait(1).to({skewX:1.3,skewY:0.9,x:1090.8,y:529.4,startPosition:61},0).wait(1).to({skewX:1.2,skewY:0.8,x:1094.5,y:551.8,startPosition:62},0).wait(1).to({skewX:1,x:1096.1,y:547,startPosition:63},0).wait(1).to({skewX:0.9,skewY:0.7,x:1097.7,y:542.1,startPosition:64},0).wait(1).to({skewX:0.8,x:1099.3,y:537.3,startPosition:65},0).wait(1).to({rotation:0.7,skewX:0,skewY:0,x:1101,y:532.5,startPosition:66},0).wait(1).to({rotation:0,skewX:0.6,skewY:0.7,x:1102.5,y:527.6,startPosition:67},0).wait(1).to({skewX:0.5,x:1104.2,y:522.8,startPosition:68},0).wait(1).to({skewX:0.4,x:1105.8,y:517.9,startPosition:69},0).wait(1).to({skewX:0.3,x:1107.4,y:513.1,startPosition:0},0).wait(1).to({skewX:0.2,skewY:0.6,x:1109,y:508.3,startPosition:1},0).wait(1).to({skewX:0.1,x:1110.6,y:503.4,startPosition:2},0).wait(1).to({skewX:-0.1,x:1112.2,y:498.6,startPosition:3},0).wait(1).to({skewX:-0.2,x:1113.8,y:493.7,startPosition:4},0).wait(1).to({skewX:-0.3,x:1115.4,y:488.9,startPosition:5},0).wait(1).to({skewX:-0.4,x:1117,y:484.1,startPosition:6},0).wait(1).to({skewX:-0.5,x:1118.6,y:479.2,startPosition:7},0).wait(1).to({skewX:-0.6,x:1120.3,y:474.4,startPosition:8},0).wait(1).to({skewX:-0.7,skewY:0.5,x:1121.8,y:469.5,startPosition:9},0).wait(1).to({skewX:-0.8,x:1123.5,y:464.7,startPosition:10},0).wait(1).to({skewX:-0.9,x:1125.1,y:459.9,startPosition:11},0).wait(1).to({x:1130.8,y:465,startPosition:12},0).wait(1).to({x:1136.5,y:470.2,startPosition:13},0).wait(1).to({x:1142.3,y:475.3,startPosition:14},0).wait(1).to({x:1148,y:480.5,startPosition:15},0).wait(1).to({x:1153.7,y:485.6,startPosition:16},0).wait(1).to({x:1170.7,y:483.6,startPosition:17},0).wait(1).to({x:1188.2,y:481.5,startPosition:18},0).wait(1).to({x:1173.6,y:482.4,startPosition:19},0).wait(1).to({x:1154.7,y:482.9,startPosition:20},0).wait(1).to({x:1137.3,y:483.2,startPosition:21},0).wait(1).to({x:1119.9,y:483.4,startPosition:22},0).wait(1).to({skewX:-0.4,skewY:1,x:1101.5,y:483.6,startPosition:23},0).wait(1).to({skewX:0.1,skewY:1.6,x:1082.3,startPosition:24},0).wait(1).to({skewX:0.6,skewY:2.1,x:1088.7,y:483.3,startPosition:25},0).wait(1).to({skewX:1.1,skewY:2.6,x:1107.8,y:482.9,startPosition:26},0).wait(1).to({skewX:1.7,skewY:3.1,x:1124.7,y:482.6,startPosition:27},0).wait(1).to({skewX:2.2,skewY:3.7,x:1203.6,y:481.7,startPosition:28},0).wait(1).to({skewX:2.7,skewY:4.2,x:1282.7,y:481.2,startPosition:29},0).wait(1).to({skewX:3.2,skewY:4.7,x:1361.7,y:480.8,startPosition:30},0).wait(1).to({skewX:3.8,skewY:5.2,x:1440.7,y:480.6,startPosition:31},0).wait(1).to({skewX:4.3,skewY:5.7,x:1519.7,y:480.3,startPosition:32},0).wait(1).to({skewX:4.8,skewY:6.3,x:1598.7,y:480.1,startPosition:33},0).wait(1).to({skewX:5.3,skewY:6.8,x:1677.7,y:479.9,startPosition:34},0).wait(1).to({skewX:5.8,skewY:7.3,x:1756.8,y:479.7,startPosition:35},0).wait(1).to({skewX:6.4,skewY:7.8,x:1835.7,y:479.4,startPosition:36},0).wait(1).to({skewX:6.9,skewY:8.4,x:1914.8,y:478.9,startPosition:37},0).wait(1).to({skewX:7.4,skewY:8.9,x:1993.7,y:478.4,startPosition:38},0).wait(1).to({skewX:7.9,skewY:9.4,x:2072.8,y:477.6,startPosition:39},0).wait(1).to({skewX:8.5,skewY:9.9,x:2151.8,y:476.7,startPosition:40},0).wait(1).to({skewX:9,skewY:10.4,x:2230.9,y:475.3,startPosition:41},0).wait(1).to({skewX:9.5,skewY:11,x:2309.8,y:473.5,startPosition:42},0).wait(1).to({skewX:10,skewY:11.5,x:2388.8,y:470.5,startPosition:43},0).wait(1).to({skewX:10.5,skewY:12,x:2467,y:461.5,startPosition:44},0).to({_off:true},1).wait(135));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-10.9,133.4,620.9,1015.9);
